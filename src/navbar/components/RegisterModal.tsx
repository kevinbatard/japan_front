...
export default function RegisterModal() {
    ...
    const isPasswordOk = (password: string): void | boolean => {
        const length: RegExp = /^.{8,32}$/;
        const specChar: RegExp = /(?=.*[*.!@$%^&(){}[\]:;<>,.?~_+-=|])/;
        ...
        if (!lowerCase.test(password)) {
            ...
            return failToast(
                'Le mot de passe doit avoir entre 8 et 32 caractères.'
            );
        }
        return true;
    };
                        ...
                        <div className="my-3">
                            ...
                            <div className="mb-3">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        setTimeout(() => {
                                            if (isPasswordOk(e.target.value))
                                ...
                                <div
                                    ...
                                    className="form-text"
                                >
                                    Votre mot de passe doit contenir entre 8-32
                                    caractères, contenir lettre et chiffre, sans
                                    espace, au moins un caractère spécial et une
                                    majuscule.
                                </div>
                                <div className="my-3">
                                    <label
